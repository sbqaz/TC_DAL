...
//        private IConnectionService _client;

//        [SetUp]
//        public void Init()
//        {
//            _client = Substitute.For<IConnectionService>();
//            uut = new TCDataConnection() { MyConnectionService = _client };
//            uutWithPosition = new TCDataConnection() { ApiDirectory = "api/Position/", MyConnectionService = _client };
